...
<body>
  ...
  <div class="container d-flex align-items-center justify-content-center flex-column">
    <h1 style="margin: 30px">Dados do Produto</h1>
    <div class="card text-center" style="width: 18rem;">
      <img class="card-img-top card-custom" src="data:image/jpeg;base64,<?php echo base64_encode($imagem);?>" alt="Imagem do Produto">
      <div class="card-body">
        ...
        <form method="post" action="Atualizar2.php">
          ...
          <h2 class="fnt_warning">Você tem certeza que deseja alterar este item?</h2><br>

          <button type="submit" name="confirmar" value="sim" class="btn btn-success">Sim</button>
          <button type="submit" name="confirmar" value="nao" formaction="../ADM/Atualizar.html" class="btn btn-danger">Não</button>
        </form>
      </div>
    </div>
  </div>
