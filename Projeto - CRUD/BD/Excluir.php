    ...
    <div class="card text-center" style="width: 18rem;">
      ...
      <div class="card-body">
        ...
        <form method="post" action="Excluir2.php">
          ...
          <h2 class="fnt_warning">Você tem certeza que deseja excluir este item?</h2><br>

          <button type="submit" name="confirmar" value="sim" class="btn btn-success">Sim</button>
          <button type="submit" name="confirmar" value="nao" formaction="../ADM/Excluir.html" class="btn btn-danger">Não</button>
        </form>
      </div>
    </div>
  </div>
