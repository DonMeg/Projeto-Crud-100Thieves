...
<body>
  ...
  <div class="container">
    ...
    <?php
        ...
        $sql = "INSERT INTO formulario VALUES (default, '$nome', '$sobrenome', '$email', '$assunto', '$informacao', '$arquivo');";

        if($conexao -> query($sql)){
            echo "<div class='container text-center'>
                <h1 style='margin: 200px;'>Formulário Enviado com Sucesso!!!</h1>
                </div>";
        }else{
    ...
    <div class="container">
        ...
        <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-4">
            ...
            <div class="col mb-3">
                ...
                <li class="nav-item mb-2"><a href="Contato.html" class="nav-link p-0 text-dark">Contato</a></li>
                </ul>
            </div>
            <!--Coluna 4-->
            <div class="col mb-3">
