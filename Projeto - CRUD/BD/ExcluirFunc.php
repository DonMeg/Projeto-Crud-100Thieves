...
<div class="container">
        ...
        <div class="mb-3">
            <form method="post" action="ExcluirFunc2.php" enctype="multipart/form-data">
                <div class="row-6">
                ...
                <div class="row-6">
                    ...
                    <input readonly type="text" class="form-control" id="exampleFormControlInput1" name="nome" placeholder="Digite o Nome do Funcionário" value="<?php echo $nome?>">
                </div>
                <div class="row-6">
                    <label for="exampleFormControlInput1" class="form-label"><strong>E-mail do Funcionário</strong></label>
                    <input readonly type="email" class="form-control" id="exampleFormControlInput1" name="email" placeholder="Digite o E-mail do Funcionário" value="<?php echo $email?>">
                </div>
                <div class="row-6">
                    <label for="exampleFormControlInput1" class="form-label"><strong>Senha do Funcionário</strong></label>
                    <input readonly type="text" class="form-control" id="exampleFormControlInput1" name="senha" placeholder="Digite a Senha do Funcionário" value="<?php echo $senha?>">
                </div>
                <br>
