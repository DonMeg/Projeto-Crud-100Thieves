...
<body>
  <!--Menu-->
    ...
    <?php
        ...
        $sql = ("UPDATE adm SET nome = '$nome', email = '$email', senha = '$senha' WHERE id = '$id'") or die(mysqli_error($conexao));
    ...
    <div class="container">
      ...
      <div class="mb-3">
        ...
        <div class="row-6">
            ...
            <p id="senha"><?php echo $senha?></p>
        </div>
        <a href="../ADM/AtualizarADM.html"><button class="btn btn-danger">Voltar</button></a>
      </div>
    </div>
