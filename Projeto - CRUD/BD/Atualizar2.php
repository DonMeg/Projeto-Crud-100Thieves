...
<body>
    ...
    $id = $_POST['id'];
    $sql = ("SELECT * FROM loja WHERE id = '$id'") or die(mysqli_error($conexao));
  ...
  ?>
    ...
    <div class="container">
        ...
        <div class="mb-3">
            <form method="post" action="Atualizar3.php" enctype="multipart/form-data">
                <div class="row-6">
                ...
                <div class="row-6">
                    <label for="exampleFormControlInput1" class="form-label"><strong>Nome do Produto</strong></label>
                    <input required type="text" class="form-control" id="exampleFormControlInput1" name="nome" placeholder="Digite o Nome do Produto" value="<?php echo $nome?>">
                </div>
                <div class="row-6">
                    <label for="exampleFormControlInput1" class="form-label"><strong>Preço do Produto</strong></label>
                    <input required type="text" class="form-control" id="exampleFormControlInput1" name="preco" placeholder="Digite o Preço do Produto" value="<?php echo $preco?>">
                </div>
                <div class="row-6">
                    <label for="exampleFormControlInput1" class="form-label"><strong>Quantidade do Produto</strong></label>
                    <input required type="text" class="form-control" id="exampleFormControlInput1" name="qnt" placeholder="Digite a Quantidade do Produto" value="<?php echo $qnt?>">
                </div>
                <div class="row-6">
                    <label for="exampleFormControlInput1" class="form-label"><strong>Imagem do Produto</strong></label>
                    <br>
                    <img src="data:image/jpeg;base64,<?php echo base64_encode($imagem); ?>" alt="Imagem do Produto" style="max-width: 200px; max-height: 200px;">
                    <br><br>
                    <input type="file" class="form-control" name="imagem" id="exampleFormControlInput1">
                </div>
                <br>
