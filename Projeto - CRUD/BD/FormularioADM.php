...
<body>
    ...
    <div class="container text-center">
        <div class="row">
        <h1 style="margin-top: 30px">Formulários dos Clientes</h1>
            <?php
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<div class="col-md-3 mb-4">
                            <div class="email-card h-100 d-flex flex-column">
                                <h3>'.$row['assunto'] .'</h3>
                                <hr>
                                <p style="text-align: justify;"><strong>Nome:</strong> '.$nomeCompleto.'</p>
                                <p style="text-align: justify;"><strong>Email:</strong> '.$row['email'].'</p>

                                <p style="text-align: justify;"><strong>Informações Adicionais:</strong></p>
                                <p style="text-align: justify;">' . $row['informacao'] . '</p>
                                <p><strong>Anexo:</strong></p>';
                        
                    //Verifica se há um arquivo
                    if ($row['arquivo']) {
                      echo '<img src="data:image/jpeg;base64,'.base64_encode($row['arquivo']).'" alt="Arquivo">';
                    } else {
